...
module.exports = {
  ...
  ***************************************************************************/
  sockets: {
    ...
    *                                                                          *
    ***************************************************************************/
    onlyAllowOrigins: process.env.SOCKET_ONLY_ALLOW_ORIGINS.split(',')
  ...
  ***************************************************************************/
  custom: {
    baseUrl: 'https://sails-angular.fdn-dev.iwi.unibe.ch',
    internalEmailAddress: 'support@fdn-dev.iwi.unibe.ch',
